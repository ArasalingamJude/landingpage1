...
function App() {
  return (
    <>
      ...
      <div
        className="App pt-5 pb-20 mt-0 font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"
        style={{
          backgroundImage: "url('https://source.unsplash.com/1L71sPT5XKc')",
        }}
      >
        <div className="max-w-4xl pb-10 items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          <div className="flex mt-20 shadow-2xl rounded-3xl">
            <div
              id="profile"
              className="w-full  lg:w-3/5 rounded-l-3xl shadow-xl bg-white  mx-6 lg:mx-0"
            >
              <div className="p-4 md:p-12 text-center lg:text-left ">
                ...
                <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                  ...
                  Latitude 9.74303° - Longitude 80.02883°
                </p>
                <p className="pt-8 text-sm">
                  My home town is Jaffna. I study at South Eastern University of
                  Srilanka.
                </p>
                ...
                <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                  <a
                    className="link"
                    href="https://www.facebook.com/profile.php?id=100081194635278"
            ...
            <div className="w-full lg:w-2/5 ">
              <img
                src={jude}
                alt="img"
                className="rounded-r-3xl shadow-2xl hidden lg:block"
              />
