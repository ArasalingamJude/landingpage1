...
function App() {
  return (
    ...
    <>
    <div className="App pt-10 mt-10 font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style={{backgroundImage:"url('https://source.unsplash.com/1L71sPT5XKc')"}}>
       <div className="max-w-4xl  items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    
<div className="flex mt-20 shadow-2xl rounded-3xl">
    <div id="profile" className="w-full  lg:w-3/5 rounded-l-3xl shadow-xl bg-white opacity-75 mx-6 lg:mx-0">
    ...
    <div className="w-full lg:w-2/5 ">
     ...
     <img src={jude} alt="img" className="rounded-r-3xl shadow-2xl hidden lg:block"/>
...
<div className="users p-20">
  <div className="flex flex-wrap justify-center">
      {users.map((user) => (
        <div className="user  p-5 bg-slate-400 w-60 mb-10 ml-5" key={user.id}>
          <div className="pl-5 rounded-full"><img src={images[user.id]} className=" max-h-40 rounded-full"></img></div>
